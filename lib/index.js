...
function viewerHtml(base64, customStyle, withScroll, bundleJS) {
    return `
<!DOCTYPE html>
<html>
  <head>
...
async function writeWebViewReaderFileAsync(data, customStyle, withScroll) {
...
class PdfReader extends React.Component {
    constructor() {
        ...
        this.init = async () => {
            try {
                ...
                switch (renderType) {
                    ...
                    case 'DIRECT_BASE64': {
                        await writeWebViewReaderFileAsync(source.base64, customStyle, withScroll);
                        break;
                    }
        ...
        this.getRenderType = () => {
            const { useGoogleReader, source: { uri, base64 }, alwaysUseHtmlViewer } = this.props;
            if (useGoogleReader) {
    ...
    render() {
        ...
        if (ready) {
            ...
            return (React.createElement(View, { style: [styles.container, containerStyle] },
                ...
                }, { allowFileAccess: isAndroid, scalesPageToFit: Platform.select({ android: false }), mixedContentMode: isAndroid ? 'always' : undefined, sharedCookiesEnabled: false, startInLoadingState: !noLoader, renderLoading: () => (noLoader ? React.createElement(View, null) : React.createElement(Loader, null)) }, webviewProps))));
        }
